...
selectElement.addEventListener('change', function() {
    ...
    dynamicContentContainer.appendChild(dv.table(["链接", "封面", "作者", "领域"], tag_pages.map(b => [b.file.link, b.cover, b.author, b.category])));

    for (let page of tag_pages) {
    dynamicContentContainer.appendChild(dv.table(["链接", "封面", "作者", "领域"], tag_pages.map(b => [b.file.link, b.cover, b.author, b.category])));//列出满足选项
